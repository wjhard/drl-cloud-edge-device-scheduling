...
DEFAULT_OUTPUT = "training/bc_datasets/mlp_ranked_bc_dataset_normalized.npz"
...
def generate_ranked_bc_dataset(
    ...
    for dag_index in range(num_dags):
        ...
        for task_id in task_order:
            ...
            action = raw_env.ready_tasks.index(task_id)
    ...
    print("RANKED_BC_DATASET_GENERATION")
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Generate HEFT task-order BC dataset for ranked PPO.")
